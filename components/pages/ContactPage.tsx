            ...
            <FadeUp>
              <div className="bg-cream rounded-3xl p-9">
                ...
                {[
                  ...
                  { label: "Phone", value: "+91 99186 51694", icon: "📞" },
                  ...
                  <div className="flex gap-2.5">
                    {socials.map((s) => (
                      <a
                        ...
                        className="w-10 h-10 rounded-full border-[1.5px] border-gold/30 flex items-center justify-center text-richbrown-mid hover:border-gold hover:text-gold transition-all"
                      >
                        {s.icon}
                      </a>
                    ))}
